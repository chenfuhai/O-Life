...
public class OlifeFragmentManager {
    private static OlifeFragmentManager mOlifeFragmentManager;
    private Activity mActivity;
    private int mFragmentPosition;
    ArrayList<Fragment> mFragments;


    private OlifeFragmentManager(Activity currActivity, int fragmentPosition) {
     ...
     * @return
     */
    public static OlifeFragmentManager getInstance(Activity currActivity, int fragmentPosition) {
        if (mOlifeFragmentManager == null) {
            synchronized (OlifeFragmentManager.class) {
                if (mOlifeFragmentManager == null) {
                    return new OlifeFragmentManager(currActivity, fragmentPosition);
                }
            }
        }
        return mOlifeFragmentManager;
    }
