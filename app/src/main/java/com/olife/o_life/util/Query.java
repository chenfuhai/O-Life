...
public class Query {
    ...
    private String[] WhereLessThanOrEqualTo;
    private String[] WhereGreaterThanOrEqualTo;

    public String[] getWhereLessThanOrEqualTo() {
        return WhereLessThanOrEqualTo;
    }

    public void setWhereLessThanOrEqualTo(String[] whereLessThanOrEqualTo) {
        WhereLessThanOrEqualTo = whereLessThanOrEqualTo;
    }

    public String[] getWhereGreaterThanOrEqualTo() {
        return WhereGreaterThanOrEqualTo;
    }

    public void setWhereGreaterThanOrEqualTo(String[] whereGreaterThanOrEqualTo) {
