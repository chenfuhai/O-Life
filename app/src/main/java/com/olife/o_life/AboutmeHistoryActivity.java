        ...
        mRecyclerView.setOnLoadMoreListener(new OnLoadMoreListener() {
            ...
            public void onLoadMore() {
                ...
                if (state == LoadingFooter.State.Loading) {
                    Toast.makeText(AboutmeHistoryActivity.this, "加载中，请稍后", Toast.LENGTH_SHORT).show();
                    return;
                }
                //上拉的时候就设置为加载中 然后请求网络的数据 请求成功以后进行相应的操作
                RecyclerViewStateUtils.setFooterViewState(AboutmeHistoryActivity.this, mRecyclerView,
